        ...
        <section className="rounded-[2.5rem] border border-white/10 bg-white/[0.055] p-8 shadow-2xl shadow-slate-950/20 backdrop-blur-xl transition duration-300 hover:border-emerald-300/20">
          ...
          <div className="flex flex-col items-center sm:flex-row sm:items-start gap-8">
            ...
            <div className="flex-1 space-y-6 text-center sm:text-left">
              ...
              <button onClick={openEditModal} className="mt-2 rounded-xl border border-white/10 bg-white/5 px-6 py-2.5 text-xs font-bold text-emerald-100 transition hover:bg-emerald-400/10 hover:border-emerald-500/30">
                Edit Profile
              </button>
            </div>
          </div>
